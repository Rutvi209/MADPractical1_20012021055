class Matrix(private val matrix: Array<IntArray>, private val rows: Int, private val
        cols: Int) {
...
fun main() {
    val firstMatrix = Matrix(arrayOf(intArrayOf(3, -2, 5), intArrayOf(3, 0, 4)), 2,
        3)
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(2, 3), intArrayOf(-9, 0),
        intArrayOf(0, 4)), 3, 2)
    val secondMatrix2 = Matrix(arrayOf(intArrayOf(6, 3), intArrayOf(9, 0),
        intArrayOf(5, 4)), 3, 2)
    println("-------Addition-------")
    println("Matrix 1 : ")
